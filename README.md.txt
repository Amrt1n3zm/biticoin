...
Crea un libro mayor público cuyo UTXOPool actual (colección de salidas de transacción no utilizadas) 

es * {@code utxoPool}.

 Esto se hara por medio de  una copia de utxoPool utilizando el  Constructor UTXOPool (UTXOPool uPool)
...
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\Crypto.java:15: warning: no @param for pubKey
    public static boolean verifySignature(PublicKey pubKey, byte[] message, byte[] signature) {
                          ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\Crypto.java:15: warning: no @param for message
    public static boolean verifySignature(PublicKey pubKey, byte[] message, byte[] signature) {
                          ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\Crypto.java:15: warning: no @param for signature
    public static boolean verifySignature(PublicKey pubKey, byte[] message, byte[] signature) {

D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\TxHandler.java:21: warning: no @param for tx
    public boolean isValidTx(Transaction tx) {
                   ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\TxHandler.java:31: warning: no @param for possibleTxs
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
                         ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\TxHandler.java:31: warning: no @return
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
                         ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\TxHandler.java:8: warning: no @param for utxoPool
    public TxHandler(UTXOPool utxoPool) {
           ^
                                                                 ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXO.java:15: warning: no @param for txHash
    public UTXO(byte[] txHash, int index) {
           ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXO.java:15: warning: no @param for index
    public UTXO(byte[] txHash, int index) {
           ^
Generating D:\Nueva carpeta\biti\pr00_biticoin\doc\UTXOPool.html...
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:23: warning: no @param for utxo
    public void addUTXO(UTXO utxo, Transaction.Output txOut) {
                ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:23: warning: no @param for txOut
    public void addUTXO(UTXO utxo, Transaction.Output txOut) {
                ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:28: warning: no @param for utxo
    public void removeUTXO(UTXO utxo) {
                ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:36: warning: no @param for ut
    public Transaction.Output getTxOutput(UTXO ut) {
                              ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:41: warning: no @param for utxo
    public boolean contains(UTXO utxo) {
                   ^
D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:46: warning: no @return
    public ArrayList<UTXO> getAllUTXO() {
                           ^



D:\Nueva carpeta\biti\pr00_biticoin\src\main\java\UTXOPool.java:18: warning: no @param for uPool
    public UTXOPool(UTXOPool uPool) {
           ^
Crea un libro mayor público cuyo UTXOPool actual 



es * {@code utxoPool}.

 Esto se hara por medio de  una copia de utxoPool 

utilizando el  Constructor UTXOPool (UTXOPool uPool)
