...
public class TxHandler {
	...
	//public UTXOPool getUtxoPool() {
	  ...
	  //new TxHandler(utxoPool);
  	//	return ;
	 //Tx tx = new Tx();
	// TxHandler txhandler = new TxHandler();
     //tx.addOutput(10, pk_scrooge.getPublic());
    //public TxHandler(UTXOPool utxoPool) {
    //	System.out.println("iniciando txhandler");
    //}
	/** Creates a new TxHandler  that is a copy of {@code utxoPool} */
    // public TxHandler(TxHandler utxoPool) {
   	//  new TxHandler(utxoPool);
   	  //System.out.println("creando txhandler");  
   ...
   // }
    ...
    public Transaction[] handleTxs(Transaction[] possibleTxs) {
    	// new TxHandler;
    	//TxHandler txHandler = new TxHandler(possibleTxs);
    	//return possibleTxs;
        // IMPLEMENT THIS
    //}
